// --- UTILS ---
        ...
        const estimateAnnualMortgageInsuranceRate = ({ loanType, homePrice, downPayment }) => {
        ...
        const computeLoanFromPayment = (payment, monthlyRate, months) => {
        ...
        const solveRateFromPayment = (amountFinanced, payment, months) => {
        ...
        const computeMortgageInsuranceForPeriod = ({
            loanType,
        ...
        const simulateMortgageSchedule = ({
            loanAmount,
            annualRate,
            termMonths,
            frequency,
        ...
        const simulateFixedPaymentLoan = ({ balance, monthlyRate, payment, maxMonths = 1200 }) => {
